		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12" style="color:#446CB3">
				   <h1 class="page-header">Laporan Lahan Kabupaten Siodarjo</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<div class ="row">
								...
								<table id="lahanAll" class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td><?php echo $i['fs_dialokasikan']?></td>
											<td><?php echo $i['fs_pembebasan']?></td>
											<td><?php echo $i['fs_sudah_dimatangkan']?></td>
